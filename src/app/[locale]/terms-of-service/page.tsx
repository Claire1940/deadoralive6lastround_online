...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Dead or Alive 6 Last Round Wiki",
    description: "Read the Terms of Service for Dead or Alive 6 Last Round Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our fighting game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Dead or Alive 6 Last Round Wiki",
      description: "Terms and conditions for using Dead or Alive 6 Last Round Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Dead or Alive 6 Last Round Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Dead or Alive 6 Last Round Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Dead or Alive 6 Last Round Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Dead or Alive 6 Last Round Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the fighting game "Dead or Alive 6 Last Round". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Character and roster guides</li>
              <li>Tier lists and matchup strategies</li>
              <li>Combo and frame data guides</li>
              <li>Stage and Danger Zone information</li>
              <li>Costume and DLC unlock guides</li>
              <li>Core Fighters and Last Round coverage</li>
            </ul>
            <p>
              <strong>Important:</strong> Dead or Alive 6 Last Round Wiki is NOT affiliated with, endorsed by, or associated with
              Team NINJA, Koei Tecmo, Valve Corporation (Steam), or the official developers and publishers of Dead or Alive 6 Last Round. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Dead or Alive 6 Last Round Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Team NINJA, Koei Tecmo, and/or the developers of Dead or Alive 6 Last Round. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Game, Core Fighters, and Last Round content availability may change without notice. We are not responsible for access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, DEAD OR ALIVE 6 LAST ROUND WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Dead or Alive 6 Last Round Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@deadoralive6lastround.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@deadoralive6lastround.online</a>
            </p>
            <p>
