...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Dead or Alive 6 Last Round Wiki',
    description: 'Copyright and intellectual property information for Dead or Alive 6 Last Round Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Dead or Alive 6 Last Round Wiki',
      description: 'Copyright and intellectual property information for Dead or Alive 6 Last Round Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Dead or Alive 6 Last Round Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Dead or Alive 6 Last Round Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Dead or Alive 6 Last Round Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Operator of the Steam platform</li>
              <li><strong>Team NINJA / Koei Tecmo</strong> - Developer and publisher of Dead or Alive 6 Last Round</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Dead or Alive 6 Last Round</strong> - Trademark of Koei Tecmo / Team NINJA</li>
              <li><strong>Dead or Alive 6 Last Round Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Dead or Alive 6 Last Round Wiki.
            </p>
            ...
            <p>
              ...
              Dead or Alive 6 Last Round Wiki<br />
              Email: <a href="mailto:dmca@deadoralive6lastround.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@deadoralive6lastround.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Dead or Alive 6 Last Round Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Dead or Alive 6 Last Round Wiki (deadoralive6lastround.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@deadoralive6lastround.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@deadoralive6lastround.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@deadoralive6lastround.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@deadoralive6lastround.online</a>
            </p>
            <p>
