...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://deadoralive6lastround.online'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Dead or Alive 6 Last Round Wiki'
