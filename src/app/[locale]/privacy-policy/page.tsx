...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Dead or Alive 6 Last Round Wiki',
    description: 'Dead or Alive 6 Last Round Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our fighting game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Dead or Alive 6 Last Round Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Dead or Alive 6 Last Round Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Team NINJA, Koei Tecmo, Valve Corporation (Steam), or the developers of Dead or Alive 6 Last Round. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@deadoralive6lastround.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@deadoralive6lastround.online</a>
            </p>
            <p>
